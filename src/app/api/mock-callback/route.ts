...
export async function POST(request: NextRequest) {
  try {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_ALIEN_SSO_ROUTER_URL}/app_callback/${id}`, {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({
        ...
        session_signature:
          'DE735FFF3CA2E29F528BA3E7B4FBBFC5B51F17F43C6B9BB14F2BC5EF0528277449ED33718C1500B14BBAB83602B6CAC35DA61100658EADFC6BC4E762F47ED60F',
